 ...
 * @author tstreit
 */
public class AutoPasswordEmployee {

    private static final Logger logger = Logger.getLogger(AutoPasswordEmployee.class.getName());
    ...
    private static void SendMail(String pass) throws IOException {
        ...
        try {
            ...
            message.setContent("The new Wifi Password for Belt-Employee is " + pass,
                    "text/html");
            logger.info("The new Wifi Password for Belt-Employee is " + pass);
